...
<head>
  ...
  <title>Inscription administrative - La Courtille</title>
  ...
  <section class="breadcrumb-bg" style="background-image: url(assets/img/tableau.jpg); ">
    <div class="container">
      <div class="breadcrumb-holder">
        <div>
          <h1 class="breadcrumb-title">Rôle du médiateur</h1>
          <ul class="breadcrumb breadcrumb-transparent">
            <li class="breadcrumb-item">
              <a class="text-white" href="javascript:void(0)">Présentation</a>
            </li>
  ...
  <section class="pt-7 pt-md-10">
    <div class="container">
      <div class="row wow fadeInUp">
        <div class="col-sm-8 col-xs-12 pe-8">
            <div class="section-title mb-4 wow fadeInUp">
              <h2 class="text-danger">Les 3 missions du médiateur à l'école</h2>
            </div>
            <div class="align-items-baseline mb-4 " >
                <div class="row progress-wizard" style="border-bottom:0;margin-top: 100px;" >
                    <div class="col-sm-4 col-xs-12 progress-wizard-step incomplete">
                        ...
                        <div class="progress-info">Développer les comportements citoyens et une culture du dialogue et de la tolérance</div>
                    </div>
          
                      <div class="col-sm-4 col-xs-12 progress-wizard-step incomplete">
                          <div class="progress"><div class="progress-bar"></div></div>
                          <a href="javascript:void(0)" class="progress-wizard-dot">
                            <i class="fa" aria-hidden="true">2</i>

                          </a>
                          <div class="progress-info">Prévenir et lutter contre les violences, les conflits et le harcèlement</div>
                      </div>
          
                      <div class="col-sm-4 col-xs-12 progress-wizard-step incomplete">
                          <div class="progress"><div class="progress-bar"></div></div>
                          <a href="javascript:void(0)" class="progress-wizard-dot">
                              <i class="fa" aria-hidden="true">3</i>
                          </a>
                          <div class="progress-info">Prévenir et lutter contre l'absentéisme et le décrochage scolaire</div>
                      </div>
                  </div>
            </div>
          
      </div>
      <div class="col-sm-4 col-xs-12 mb-6">
          <div>
            <img class="img-fluid rounded" src="assets/img/mediateur.jpg" width="90%" allowfullscreen="" loading="lazy">
          </div>
  ...
  <section class="pt-4 pt-md-6 pb-10">
    <div class="container">
        ...
        <div class="align-items-baseline mb-4 px-5">
            <p class="text-dark font-size-15 mb-4">Dans ses activités au collège le médiateur scolaire travaille sur la prévention et la gestion des conflits.
  </p>
  
            <ul class="list-unstyled mb-5">
              <li class="d-flex align-items-baseline text-muted mb-2">
                              <i class="fa fa-check me-2" aria-hidden="true"></i>
                              <p><small class="text-danger font-size-15 mb-4">La prévention et la gestion des conflits,</small> 
                                par les techniques de la médiation, permettant
                                de dénouer des situations complexes et d'amener
                                les parties à trouver une solution concertée.</p>					</li>
              <li class="d-flex align-items-baseline text-muted mb-2">
                              <i class="fa fa-check me-2" aria-hidden="true"></i>
                              <p><small class="text-danger font-size-15 mb-4">La mise en place d'actions de sensibilisation et
                                de projets participatifs</small> pour valoriser le potentiel
                                des élèves et contribuer à leur inclusion dans la vie
                                scolaire.</p>
                          </li>
              <li class="d-flex align-items-baseline text-muted mb-2">
                              <i class="fa fa-check me-2" aria-hidden="true"></i>
                              <p><small class="text-danger font-size-15 mb-4">La médiation par les pairs</small> pour rendre les élèves
                                acteurs du bien-être à l'école et favoriser leur
