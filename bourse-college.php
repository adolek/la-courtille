...
<head>
  ...
  <title>Bourse collège - La Courtille</title>
  ...
  <section class="breadcrumb-bg" style="background-image: url(assets/img/tableau.jpg); ">
    <div class="container">
      <div class="breadcrumb-holder">
        <div>
          <h1 class="breadcrumb-title">Bourse collège</h1>
...
<section class="bg-light py-8 py-md-10">
  <div class="container">
   ...
   <ul class="list-unstyled mb-5">
          ...
          <h3 class="text-danger mt-5 mb-3" style="font-family: dosis, sans-serif; font-weight: bold; font-style: italic;">Connectez-vous à FranceConnect : </h3>
          <div style="text-align: center;">
          <a href="https://partenaires.franceconnect.gouv.fr/login"><img  src="assets/img/fr-connect.png" width="280px" height="80"></a>
          </div>
