    ...
    <section class="breadcrumb-bg" style="background-image: url(assets/img/tableau.jpg); ">
      <div class="container">
        <div class="breadcrumb-holder">
          <div>
            <h1 class="breadcrumb-title">Tarification particuliere</h1>
  ...
  <div class="container">
    <div class="row wow fadeInUp">
      <div class="section-title mb-4 wow fadeInUp">
            <h2 class="text-danger">Montant des pertes et dégradation </h2>
          </div>
          ...
          <table class="text-dark font-size-15 mb-4 font-size-20" style="width:100%">
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Dégradation</td>
              <td class="pb-2 pt-3"><?php echo $m[10];?></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Manuels scolaires perdu</td>
              <td class="pb-2 pt-3"><?php echo $m[11];?></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Manuels scolaires dégradés</td>
              <td class="pb-2 pt-3"><?php echo $m[12];?></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Livres CDI perdus ou dégradés</td>
              <td class="pb-2 pt-3"><?php echo $m[13];?></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Petites Dégradations</td>
              <td class="pb-2 pt-3"><?php echo $m[14];?></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Carnet de liaison perdu</td>
              <td class="pb-2 pt-3"><?php echo $m[15];?><br>
                                    <?php echo $m[16];?></td>
            </tr>
          </table>
          <?php endif ?>
          ...
          <table class="text-dark font-size-15 mb-4 font-size-20" style="width:100%">
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Dégradation</td>
              <td class="pb-2 pt-3"><input type="text" size="60" name="modif10" value="<?php echo $m[10];?>"></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Manuels scolaires perdu</td>
              <td class="pb-2 pt-3"><input type="text" size="60" name="modif11" value="<?php echo $m[11];?>"></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Manuels scolaires dégradés</td>
              <td class="pb-2 pt-3"><input type="text" size="60" name="modif12" value="<?php echo $m[12];?>"></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Livres CDI perdus ou dégradés</td>
              <td class="pb-2 pt-3"><input type="text" size="60" name="modif13" value="<?php echo $m[13];?>"></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Petites Dégradations</td>
              <td class="pb-2 pt-3"><input type="text" size="60" name="modif14" value="<?php echo $m[14];?>"></td>
            </tr>
            <tr style="border-bottom: 1px solid #ddd;">
              <td class="pb-2 pt-3">Carnet de liaison perdu</td>
              <td class="pb-2 pt-3"><input type="text" size="60" name="modif15" value="<?php echo $m[15];?>"><br>
                                    <input type="text" size="60" name="modif16" value="<?php echo $m[16];?>"></td>
            </tr>
          </table>
          <?php endif ?>
