...
<head>
  ...
  <title>Convention de stage - La Courtille</title>
  ...
  <section class="breadcrumb-bg" style="background-image: url(assets/img/tableau.jpg); ">
    <div class="container">
      <div class="breadcrumb-holder">
        <div>
          <h1 class="breadcrumb-title">Convention de stage</h1>
...
<section class="bg-light py-8 py-md-10">
  <div class="container">
     <div class="section-title mb-4 wow fadeInUp">
        <h2 class="text-danger">Convention de stage :</h2>
   
    </div>
    <iframe src="assets/pdf/convention-stage-3e-vierge.pdf" width="100%" height="1200px">
    </iframe>
